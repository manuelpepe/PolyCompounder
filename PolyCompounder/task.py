...
class PZAPCompoundTask(CompoundTask):
    ...
    def swap_half_harvest(self):
        ...
        self._transact(
            ...
            (amountIn, amountOutMin, SWAP_PATH, self.owner, int(deadline))
        )
    ...
    def add_liquidity(self):
        ...
        self._transact(
            ...
            (SWAP_PATH[0], SWAP_PATH[1], amountADesired, amountAMin, amountBDesired, amountBMin, self.owner, int(deadline))
        )
